...
The project reflects real-world analytics practices and showcases skills required for a **Data Analyst role**.
...
* Size: Medium-sized dataset suitable for analytics
* Key Features:
...
Skills: Python | SQL | Power BI | Data Analysis | EDA | Dashboards
